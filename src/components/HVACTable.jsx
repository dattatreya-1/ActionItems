...
export default function HVACTable() {
  ...
  const fetchData = async () => {
    try {
      ...
      console.log('HVAC data received:', result)
...
function HVACFormModal({ data, onClose, onSave }) {
    ...
    <div className="modal-overlay" onClick={onClose}>
      <div className="modal-content" onClick={e => e.stopPropagation()}>
        <div className="modal-header">
          <h2>{data ? 'Edit' : 'Add'} HVAC Record</h2>
